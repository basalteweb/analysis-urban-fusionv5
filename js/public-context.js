...
AU.publicContext = (()=>{
  ...
  function correlate(model,ctx){
    ...
    if(bike?.visitsCorrelation!==null&&Math.abs(bike.visitsCorrelation)>=0.25)findings.push({level:'info',title:'Mobilité vélo corrélée à la fréquentation',text:`Sur ${bike.days} jour(s) appariés, corrélation comptages vélo / visites : ${bike.visitsCorrelation.toFixed(2)}. Corrélation ne signifie pas causalité.`});
